...
public @interface EnableEventBus {
     ...
     * if a distributed eventbus is to be used. The default-implementation
     * will take care of dispatching to the correct thread and preventing
     * memory-leaks that would occur if components are registered at the bus
     * but never unregistered
     *
    ...
    /**
     * the implementation of a {@link SessionEventBus}. If not overwritten, it defaults to
     * a guava-{@link com.google.common.eventbus.EventBus}.
     */
    Class<? extends SessionEventBus> sessionEventBus() default SessionEventBusImpl.class;

    /**
     * the implementation of a {@link UIEventBus}. If not overwritten, it defaults to
     * a guava-{@link com.google.common.eventbus.EventBus}.
     */
    Class<? extends UIEventBus> uiEventBus() default UIEventBusImpl.class;

    /**
     * the {@link Matcher} for bindings where instances should be registered on the {@link GlobalEventBus}
     *
    ...
    /**
     * the {@link Matcher} for bindings where instances should be registered on the {@link SessionEventBus}
     *
     * @see com.google.inject.AbstractModule#bindListener(Matcher, ProvisionListener...)
     */
    ...
    /**
     * the {@link Matcher} for bindings where instances should be registered on the {@link UIEventBus}
     *
     * @see com.google.inject.AbstractModule#bindListener(Matcher, ProvisionListener...)
     */
